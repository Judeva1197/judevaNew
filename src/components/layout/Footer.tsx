        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 pb-12 border-b border-white/15">
            ...
            <div>
              ...
              <ul className="space-y-2.5 font-sans text-sm text-neutral-300">
                <li>
                  <Link href="#services" className="hover:text-highlight transition-colors">Building Management</Link>
                </li>
                <li>
                  <Link href="#services" className="hover:text-highlight transition-colors">Facilities Management</Link>
                </li>
                <li>
                  <Link href="#services" className="hover:text-highlight transition-colors">Property Maintenance</Link>
                </li>
                <li>
                  <Link href="#services" className="hover:text-highlight transition-colors">Strata Building Management</Link>
                </li>
                <li>
                  <Link href="#services" className="hover:text-highlight transition-colors">Commercial Building Mgt</Link>
                </li>
                <li>
                  <Link href="#services" className="hover:text-highlight transition-colors">Onsite Building Manager</Link>
                </li>
              </ul>
            </div>
